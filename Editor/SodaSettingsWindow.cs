...
namespace Soda.EditorTools
{
    public class SodaSettingsWindow : EditorWindow
    {
        ...
        private void DrawSDKSettings()
        {
            ...
            if (settings == null)
            {
                EditorGUILayout.HelpBox("SodaSettings not found.", MessageType.Error);
            }
            else
            {
                ...
                EditorGUILayout.PropertyField(serializedSettings.FindProperty("serverUrl"), new GUIContent("Server URL"));
                
                EditorGUILayout.PropertyField(serializedSettings.FindProperty("defaultConfigName"), new GUIContent("Default Config Name"));
                EditorGUILayout.PropertyField(serializedSettings.FindProperty("enableLog"), new GUIContent("Enable Logging"));
        ...
        private void DrawOverrideConfig()
        {
            ...
            {
                EditorGUILayout.HelpBox("Override Config not found.", MessageType.Error);
            }
            else
            {
                ...
                {
                    EditorGUILayout.HelpBox("🟢 Override System ACTIVE - Using local values for testing", MessageType.Warning);
                }
        ...
        private void TestConnection()
        {
            ...
            if (!SodaSDK.IsInitialized)
            {
                ...
                {
                    EditorUtility.DisplayDialog("Test Connection", "SDK must be initialized first. Enter Play Mode to test.", "OK");
                    return;
                }
            }
